...
public class UpgradeShopUI : MonoBehaviour
{
    ...
    public void BuyUpgrade(int upgradeIndex)
    {
        ...
        if (upgradeUI != null)
        {
            ...
            upgradeUI.ShowUpgradeNotification(selectedUpgrade.type + "Lv: " + selectedUpgrade.level + " Purchased");
        }
    ...
    public void RefreshShopUI()
    {
        ...
        for (int i = 0; i < upgrades.Length; i++)
        {
            ...
            {
                upgrades[i].costText.text = "Cost: " + upgrades[i].currentCost;
            }

            if (upgrades[i].levelText != null)
            {
                upgrades[i].levelText.text = "Lv. " + upgrades[i].level;
            }
